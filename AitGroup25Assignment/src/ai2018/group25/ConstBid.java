...
/* IMPORTANT, JUST IGNORE ALL, OF THIS, THIS IS THE EXAMPLE GIVEN, WE USED IT BECAUSE IT HAS THE STRUCTURE
 * WORKING, BUT WE JUST COMMENTED ALL THE LOGIC OF determineNextBid() AND MADE THIS EXAMPLE GIVE A 
 * CONSTANT BID, JUST TO TEST THE ACCEPTANCE STRATEGY PROPERLY IN AN EASY WAY
 */
...
public class ConstBid extends OfferingStrategy {
	...
	public BidDetails determineNextBid() {
		...
		nextBid = omStrategy.getBid(outcomespace, 0.7);
		return nextBid;
	}
